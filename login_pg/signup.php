<?php
  ...
  $user =  htmlspecialchars(str_replace("&lt","",str_replace("&gt","", $_POST['username'])));
  $email =  htmlspecialchars(str_replace("&lt","",str_replace("&gt","", $_POST['email'])));
  $FullName =  htmlspecialchars(str_replace("&lt","",str_replace("&gt","", $_POST['FullName'])));
  $gender = htmlspecialchars(str_replace("&lt","",str_replace("&gt","", $_POST['gender'])));
